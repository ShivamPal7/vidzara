            ...
            <div className="relative bg-card/60 backdrop-blur-xl border border-border/50 glass-2 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="px-5 pt-6 pb-1 md:px-7 md:pt-7">
                    ...
                    <p className="text-muted-foreground text-sm mt-1">
                        Start creating viral content with Vidzara
                    </p>
                </div>
                ...
                <div className="px-5 pb-6 pt-3 md:px-7 md:pb-7">
                    <form onSubmit={handleCredentialsSignUp}>
                        <FieldGroup>
                            ...
                            <Field>
                                <Button variant="outline" type="button" onClick={handleGoogleSignIn} className="w-full glass-1 bg-background/30 hover:bg-background/50 transition-all py-5">
