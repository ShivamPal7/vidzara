        ...
        <div className="px-5 pb-6 pt-3 md:px-7 md:pb-7">
          <form onSubmit={handleCredentialsSignIn}>
            <FieldGroup>
              ...
              <Field>
                <Button variant="outline" type="button" onClick={handleGoogleSignIn} className="w-full glass-1 bg-background/30 hover:bg-background/50 transition-all py-5 md:py-6">
