import { getAffiliates, getAffiliateApplications } from "@/actions/admin/affiliates";
import {
  Table,
  TableBody,
  TableCell,
...
import { AffiliateApplicationsTab } from "@/components/admin/affiliates/affiliate-applications-tab";
      ...
      <Tabs defaultValue="partners" className="space-y-0">
        <div className="bg-zinc-950/20 border border-zinc-800/80 rounded-xl overflow-hidden backdrop-blur-sm shadow-xl">
          ...
          <div className="px-6 py-4 border-b border-zinc-800 flex items-center justify-between bg-zinc-950/30">
            <TabsList className="bg-zinc-900/60 border border-zinc-800 p-1 h-auto gap-1">
              <TabsTrigger
                value="partners"
                className="text-xs font-semibold data-[state=active]:bg-indigo-500/10 data-[state=active]:text-indigo-400 data-[state=active]:border data-[state=active]:border-indigo-500/30 text-zinc-400 hover:text-zinc-200 rounded-md px-3 py-1.5 transition-all"
              >
                Partners
                <span className="ml-1.5 text-[10px] font-mono bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded data-[state=active]:bg-indigo-500/20 data-[state=active]:text-indigo-300">
                  {affiliates.length}
                </span>
              </TabsTrigger>
              <TabsTrigger
              ...
              >
                ...
                {pendingApplicationsCount > 0 && (
                  <span className="ml-1.5 text-[10px] font-mono bg-amber-500/10 text-amber-400 border border-amber-500/20 px-1.5 py-0.5 rounded">
          ...
          <TabsContent value="applications" className="m-0">
            <AffiliateApplicationsTab applications={applications} />
          </TabsContent>
        </div>
      </Tabs>
    </div>
